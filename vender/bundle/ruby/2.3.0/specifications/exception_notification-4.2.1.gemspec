# -*- encoding: utf-8 -*-
# stub: exception_notification 4.2.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionmailer>, ["< 6", ">= 4.0"])
      s.add_runtime_dependency(%q<activesupport>, ["< 6", ">= 4.0"])
      s.add_development_dependency(%q<rails>, ["< 6", ">= 4.0"])
      ...
      s.add_dependency(%q<actionmailer>, ["< 6", ">= 4.0"])
      s.add_dependency(%q<activesupport>, ["< 6", ">= 4.0"])
